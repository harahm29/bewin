						...
						<div class="col-md-12">
							<div class="card">
								...
								@endif
									...
									<form method="post" action="{{url('sociallink/'.$sociallink->id)}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
									@csrf
									@method("PUT")
									<div class="card-body">
										...
										<div class="col-lg-9">
										<input  type="text" class="form-control" id="facebook" name="facebook" placeholder="Facebook" value="{{$sociallink->facebook}}"  >
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-9">
										<input  type="text" class="form-control" id="instagram" name="instagram" placeholder="Instagram" value="{{$sociallink->facebook}}"  >
