											...
											@foreach($contents as $content)
												<tr>
												   ...
												   <td >{{$content->instagram}}</td>
													<td>
													<form id="delete_form_{{$content->id}}" method="post" action="{{url('sociallink/'.$content->id)}}" >
													@csrf
													@method('DELETE')
														<div class="form-button-action">
														<!--<a href="{{url('sociallink/'.$content->id)}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg view" data-original-title="View">
																<i class="fa fa-eye"></i>
															</a>-->
															<a href="{{url('sociallink/'.$content->id.'/edit')}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
