						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									...
									<a align="right" href="{{url('contact')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="All Contact" ><b><i class="fa fa-list" aria-hidden="true"></i> All Contact</b></a>
								...
								@endif
									...
									<form method="post" action="{{url('contact/'.$contact->id)}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
									@csrf
									@method("PUT")
									<div class="card-body">
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-9">
										<textarea  type="text" class="form-control" id="editor" name="content" placeholder="Content Area" value="{{$contact->content}}" required >{{$contact->content}}</textarea>
