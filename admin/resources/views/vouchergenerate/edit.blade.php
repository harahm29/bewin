						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									...
									<a align="right" href="{{url('voucher')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="All Voucher" ><b><i class="fa fa-list" aria-hidden="true"></i> All Plan</b></a>
								...
								@endif
									...
									<form method="post" action="{{url('voucher/'.$voucher->id)}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
									@csrf
									@method("PUT")
									<div class="card-body">
									<div class="form-group form-show-validation row">
										...
										<select class="form-control numeric_feild select2" id="agent_id" name="agent_id" placeholder="Agent Name" value="{{old('agent_id')}}" required />
										 ...
										 <option value="{{$user->id}}" {{$user->id == $voucher->agent_id ? 'selected':'' }}>{{$user->name}}</option>
										 @endforeach
										</select>
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<input  type="text" class="form-control numeric_feild" id="amount" name="amount" placeholder="Amount" value="{{$voucher->amount}}" required />
										<div class="text-danger">{{$errors->first('amount')}}</div>							
										</div>
									</div>
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<input class="form-control numeric_feild" name="validity" id="validity" type="text" placeholder="Validity" required value="{{$voucher->validity}}" />
