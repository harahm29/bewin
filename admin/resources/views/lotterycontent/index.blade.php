				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{url('lottery')}}">Lottery Content</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header"> 
									...
									<!--<a  align="right" href="{{url('lottery-Content/create')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Add Lottery" ><b><i class="fa fa-plus" aria-hidden="true"></i> Add Lottery Content</b></a>-->
								...
								<div class="table-responsive">
										...
										<tr>
										<th>Id</th>
										<th>Lottery Content</th>
										<th>Lottery Content Description</th>
										<th>Action</th>
										</tr>
										</thead>
										...
										<tr>
										@php $i=1; @endphp
											@foreach($lotteryContent as $lottery)
												   <td>{{$i}}</td>
												   <td>{{$lottery->lottery_content}}</td>
												   <td >{!!$lottery->lottery_content_des!!} </td>
												  
												   <td> 
												   <form method="post" id="delete_form_{{$lottery->id}}" action="{{url('lottery-Content/'.$lottery->id)}}"  style="width:150px;">
													@method('DELETE')
													@csrf
												<input type="hidden" name="id" id="id" value="{{$lottery->id}}" />
												  ...
												  <a href="{{url('lottery-Content/'.$lottery->id.'/edit')}}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a>
