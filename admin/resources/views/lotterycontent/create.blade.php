   ...
   box-shadow: inset 0px 1px 1px black, 0px 1px 0px rgba(255, 255, 255, 0.9);
	...
	<div class="main-panel">
			...
			@endif
									...
									<form method="post" action="{{url('lottery-Content')}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
									@csrf
									<div class="card-body">
									<div class="form-group form-show-validation row">
										<label for="name" class="col-lg-3 ">Lottery Content <span class="required-label">*</span></label>
										<div class="col-lg-6">
										<input  type="text" class="form-control" id="lottery_content" name="lottery_content" placeholder="Lottery Content" value="{{old('lottery_content')}}">
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<textarea class="form-control" name="lottery_content_des" id="lottery_content_des"></textarea>
