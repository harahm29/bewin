...
@section('title','Past Winner Create')
@section('content')
<style>
.cus_box_info
{
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="card">
								...
								@endif
								<form method="post" action="{{url('pastwinner')}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
								@csrf
								<div class="card-body">
									<div class="card-body">
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<input  type="date" class="form-control" id="draw_date" name="draw_date" placeholder="Draw Date" value="{{old('draw_date')}}" required />
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<select  class="form-control" id="lottery_id" name="lottery_id" value="{{old('lottery_id')}}"  >
										<option value="">Select Lottery Name</option>
										@foreach($lotterys as $lottery)
										<option value="{{$lottery->id}}" {{($lottery->id==old('lottery_id'))?"selected":""}}>{{$lottery->name}}</option>
										@endforeach
										</select>
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<input  type="text" class="form-control" id="winning_no" name="winning_no" placeholder="Wnning No" value="{{old('winning_no')}}" required />
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<input  type="text" class="form-control numeric_feild" id="powerball" name="powerball" placeholder="Powerball" value="{{old('powerball')}}" required />
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<input  type="text" class="form-control" id="winning_amount" name="winning_amount" placeholder="Winning Amount" value="{{old('winning_amount')}}" required />
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<input  type="text" class="form-control" id="winner_name" name="winner_name" placeholder="Winner Name" value="{{old('winner_name')}}" required />
