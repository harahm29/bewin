	...
	<div class="main-panel">
			...
			@endif
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control numeric_feild" id="cat1_val" name="cat1_val" placeholder="" value="{{old('cat1_val')}}">
										<div class="text-danger"></div>
										</div>
										<div class="col-lg-3" >
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control numeric_feild" id="cat2_val" name="cat2_val" placeholder="" value="{{old('cat2_val')}}">
										<div class="text-danger"></div>
										</div>
										<div class="col-lg-3" >
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control numeric_feild" id="cat3_val" name="cat3_val" placeholder="" value="{{old('cat3_val')}}">
										<div class="text-danger"></div>
										</div>
										<div class="col-lg-3" >
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control numeric_feild" id="cat4_val" name="cat4_val" placeholder="" value="{{old('cat4_val')}}">
										<div class="text-danger"></div>
										</div>
										<div class="col-lg-3" >
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control numeric_feild" id="cat5_val" name="cat5_val" placeholder="" value="{{old('cat5_val')}}">
										<div class="text-danger"></div>
										</div>
										<div class="col-lg-3" >
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control numeric_feild" id="cat6_val" name="cat6_val" placeholder="" value="{{old('cat6_val')}}">
										<div class="text-danger"></div>
										</div>
										<div class="col-lg-3" >
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control numeric_feild" id="cat7_val" name="cat7_val" placeholder="" value="{{old('cat7_val')}}">
										<div class="text-danger"></div>
										</div>
										<div class="col-lg-3" >
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control numeric_feild" id="cat8_val" name="cat8_val" placeholder="" value="{{old('cat8_val')}}">
										<div class="text-danger"></div>
										</div>
										<div class="col-lg-3" >
