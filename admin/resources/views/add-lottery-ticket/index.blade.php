			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Add Lottery</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{url('addlotteryticket')}}">Lottery</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
								...
								<div class="table-responsive">
										...
										@php $i=1; @endphp
											@foreach($lotterys as $lottery)
												   ...
												   <td> 
												   <form method="post" id="delete_form_{{$lottery->id}}" action="{{url('addlotteryticket/'.$lottery->id)}}"  style="width:150px;">
													@method('DELETE')
													@csrf
												<input type="hidden" name="id" id="id" value="{{$lottery->id}}" />
											
												<span data-toggle="modal" data-target="#view_modal" ><button type="button" id="{{$lottery->id}}" url="{{url('addlotteryticket/'.$lottery->id)}}"  class="view btn btn-sm btn-info"data-toggle="tooltip" title="View">	<i class="fa fa-eye" aria-hidden="true"></i></button> </span>  
												 ...
												 <!-- <a href="{{url('lottery/'.$lottery->id.'/edit')}}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></a>-->
												  ...
												  <button type="submit" id="{{$lottery->id}}" class="btn btn-sm btn-danger delete_product" data-toggle="tooltip" title="Delete" ><i class="fa fa-trash" aria-hidden="true"></i></button>
												</td>
											</tr>
											 </form> 
										 <?php $i++; ?>
