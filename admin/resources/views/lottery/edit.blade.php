   ...
   box-shadow: inset 0px 1px 1px black, 0px 1px 0px rgba(255, 255, 255, 0.9);
	...
	<div class="main-panel">
			...
			@endif
									...
									<form method="post" action="{{url('lottery/'.$lottery->id)}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
									@csrf
									@method('PUT')
									<div class="card-body">
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<input  type="text" class="form-control" id="name" name="name" placeholder="Lottery Name" value="{{$lottery->name}}">
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-2" >
										<img   id="image_thumb" src="{{url('public/images/'.$lottery->image)}}" width="50" />
										</div>
									</div>
									<div class="form-group form-show-validation row">
										<label for="validity" class="col-lg-3 ">Validity <span class="required-label">*</span></label>
										<div class="col-lg-6">
										<input class="form-control datepicker" name="validity" id="validity" type="text" value="{{date('m/d/Y',strtotime($lottery->validity))}}" />
									...
									<div class="form-group form-show-validation row">
										...
										<label class="checkbox-inline">
										  <input type="checkbox" name="draw_days[]" class="draw_day" value="{{$week->full_day}}" @if(in_array($week->full_day,$draw_day_array)) checked @endif> {{ucfirst($week->name)}}
										</label>&nbsp;&nbsp;&nbsp;
										@endforeach
										<!--<label class="checkbox-inline">
										  <input type="checkbox" name="draw_days[]" class="draw_day" value="mon" @if(in_array("mon",$draw_day_array)) checked @endif> Mon
										</label>&nbsp;&nbsp;&nbsp;
										
										<label class="checkbox-inline">
										  <input type="checkbox" name="draw_days[]" class="draw_day" value="tue" @if(in_array("tue",$draw_day_array)) checked @endif> Tue
										</label>&nbsp;&nbsp;&nbsp;
										<label class="checkbox-inline">
										  <input type="checkbox" name="draw_days[]" class="draw_day" value="wed" @if(in_array("wed",$draw_day_array)) checked @endif> Wed
										</label>&nbsp;&nbsp;&nbsp;
										<label class="checkbox-inline">
										  <input type="checkbox" name="draw_days[]" class="draw_day" value="thu" @if(in_array("thu",$draw_day_array)) checked @endif> Thu
										</label>&nbsp;&nbsp;&nbsp;
										<label class="checkbox-inline">
										  <input type="checkbox" name="draw_days[]" class="draw_day" value="fri" @if(in_array("fri",$draw_day_array)) checked @endif> Fri
										</label>&nbsp;&nbsp;&nbsp;
										<label class="checkbox-inline">
										  <input type="checkbox" name="draw_days[]" class="draw_day" value="sat" @if(in_array("sat",$draw_day_array)) checked @endif> Sat
										</label>&nbsp;&nbsp;&nbsp;
										<label class="checkbox-inline">
										  <input type="checkbox" name="draw_days[]" class="draw_day" value="sun" @if(in_array("sun",$draw_day_array)) checked @endif> Sun
										</label>&nbsp;&nbsp;&nbsp;
										-->
									...
									<div class="form-group form-show-validation row">
										...
										<option value="{{$slot->id}}" {{$lottery->draw_timing==$slot->id?"selected":""}}>{{$slot->name}}</option>
										@endforeach
										</select>
										...
										<option value="">-Select-</option>
										@foreach($time_slots as $slot)
										<option value="{{$slot->id}}" {{$lottery->start_lottery_time==$slot->id?"selected":""}}>{{$slot->name}}</option>
										@endforeach
										</select>
									...
									<div class="form-group form-show-validation row">
										...
										<option value="">-Select-</option>
										@foreach($time_slots as $slot)
										<option value="{{$slot->id}}" {{$lottery->end_lottery_time==$slot->id?"selected":""}}>{{$slot->name}}</option>
										@endforeach
										</select>
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-6">
										<input class="form-control numeric_feild" name="ticket_price" id="ticket_price" type="text" value="{{$lottery->ticket_price}}" />
									...
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control " id="cat1_val" name="cat1_val" placeholder="" value="{{$lottery->cat1_val}}">
										<div class="text-danger">{{$errors->first('cat1_val')}}</div>
										</div>
										<div class="col-lg-3" >
										<input  type="text" class="form-control numeric_feild" id="cat1_max_winner" name="cat1_max_winner" placeholder="" value="{{$lottery->cat1_max_winner}}">
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control " id="cat2_val" name="cat2_val" placeholder="" value="{{$lottery->cat2_val}}">
										<div class="text-danger">{{$errors->first('cat2_val')}}</div>
										</div>
										<div class="col-lg-3" >
										<input  type="text" class="form-control numeric_feild" id="cat2_max_winner" name="cat2_max_winner" placeholder="" value="{{$lottery->cat2_max_winner}}">
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control " id="cat3_val" name="cat3_val" placeholder="" value="{{$lottery->cat3_val}}">
										<div class="text-danger">{{$errors->first('cat3_val')}}</div>
										</div>
										<div class="col-lg-3" >
										<input  type="text" class="form-control numeric_feild" id="cat3_max_winner" name="cat3_max_winner" placeholder="" value="{{$lottery->cat3_max_winner}}">
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control " id="cat4_val" name="cat4_val" placeholder="" value="{{$lottery->cat4_val}}">
										<div class="text-danger">{{$errors->first('cat4_val')}}</div>
										</div>
										<div class="col-lg-3" >
										<input  type="text" class="form-control numeric_feild" id="cat4_max_winner" name="cat4_max_winner" placeholder="" value="{{$lottery->cat4_max_winner}}">
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control " id="cat5_val" name="cat5_val" placeholder="" value="{{$lottery->cat5_val}}">
										<div class="text-danger">{{$errors->first('cat5_val')}}</div>
										</div>
										<div class="col-lg-3" >
										<input  type="text" class="form-control numeric_feild" id="cat5_max_winner" name="cat5_max_winner" placeholder="" value="{{$lottery->cat5_max_winner}}">
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control " id="cat6_val" name="cat6_val" placeholder="" value="{{$lottery->cat6_val}}">
										<div class="text-danger">{{$errors->first('cat6_val')}}</div>
										</div>
										<div class="col-lg-3" >
										<input  type="text" class="form-control numeric_feild" id="cat6_max_winner" name="cat6_max_winner" placeholder="" value="{{$lottery->cat6_max_winner}}">
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control " id="cat7_val" name="cat7_val" placeholder="" value="{{$lottery->cat7_val}}">
										<div class="text-danger">{{$errors->first('cat7_val')}}</div>
										</div>
										<div class="col-lg-3" >
										<input  type="text" class="form-control numeric_feild" id="cat7_max_winner" name="cat7_max_winner" placeholder="" value="{{$lottery->cat7_max_winner}}">
										...
										<div class="col-lg-3">
										<input  type="text" class="form-control " id="cat8_val" name="cat8_val" placeholder="" value="{{$lottery->cat8_val}}">
										<div class="text-danger">{{$errors->first('cat8_val')}}</div>
										</div>
										<div class="col-lg-3" >
										<input  type="text" class="form-control numeric_feild" id="cat8_max_winner" name="cat8_max_winner" placeholder="" value="{{$lottery->cat8_max_winner}}">
