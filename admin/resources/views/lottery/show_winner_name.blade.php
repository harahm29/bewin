			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Winner Name</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{url('lottery')}}">Winner Name</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="table-responsive">
										...
										<tr>
										@php $i=1; @endphp
											@foreach($winner_name as $lotterys)
												   <td>{{$i}}</td>
												   <td>{{$lotterys->first_name}} {{$lotterys->last_name}}</td>
												   <td >{{date('Y-m-d',strtotime($lotterys->today_date))}} </td>
