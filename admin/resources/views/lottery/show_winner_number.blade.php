			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Winner Number</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="{{url('lottery')}}">Winner Number</a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="table-responsive">
										...
										<tr>
										@php $i=1; @endphp
											@foreach($winner_number as $lotterys)
												   <td>{{$i}}</td>
												   <td>{{$lotterys->winning_number}}</td>
												   <td style="color:blue;">{{$lotterys->power_boll}}</td>
												   <td >{{date('Y-m-d',strtotime($lotterys->winning_number_date))}} </td>
