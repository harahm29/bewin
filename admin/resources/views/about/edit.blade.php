						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									...
									<a align="right" href="{{url('about')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="All About Us" ><b><i class="fa fa-list" aria-hidden="true"></i> All About Us</b></a>
								...
								@endif
									...
									<form method="post" action="{{url('about/'.$about->id)}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
									@csrf
									@method("PUT")
									<div class="card-body">
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-9">
										<textarea  type="text" class="form-control" id="editor" name="content" placeholder="Content Area" value="{{$about->content}}" required >{{$about->content}}</textarea>
