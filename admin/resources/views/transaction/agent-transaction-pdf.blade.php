...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="statement1_tble">
 ...
 <tbody>
    ...
    <tr>
				...
				<td align="left" valign="top" >{{$data->cr}}</td>		   
				<td align="left" valign="top" >{{$data->discount}}</td>		   
				<td align="left" valign="top"  >{{$data->discount_per}}</td>		   
				<td align="left" valign="top"  >{{$data->total}}</td>		   
    </tr>
