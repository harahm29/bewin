												...
												<tr>
												   ...
												   <td>{!! $content->contact !!}</td>
													...
													@method('DELETE')
														...
														<a href="{{url('content/'.$content->id)}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg view" data-original-title="View">
																<i class="fa fa-eye"></i>
															</a>
															<a href="{{url('content/'.$content->id.'/edit')}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
