						...
						<div class="col-md-12">
							<div class="card">
								...
								@endif
									...
									<form method="post" action="{{url('privacy')}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
									@csrf
									<div class="card-body">
									<div class="form-group form-show-validation row">
										<label for="content" class="col-lg-3 ">Content </label>
										<div class="col-lg-9">
										<textarea  type="text" class="form-control" id="editor" name="content" placeholder="Content Area" value="{{old('content')}}" required ></textarea>
