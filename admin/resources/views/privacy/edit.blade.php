						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									...
									<a align="right" href="{{url('privacy')}}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="All Privacy" ><b><i class="fa fa-list" aria-hidden="true"></i> All Privacy</b></a>
								...
								@endif
									...
									<form method="post" action="{{url('privacy/'.$privacy->id)}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
									@csrf
									@method("PUT")
									<div class="card-body">
									<div class="form-group form-show-validation row">
										...
										<div class="col-lg-9">
										<textarea  type="text" class="form-control" id="editor" name="content" placeholder="Content Area" value="{{$privacy->content}}" required >{{$privacy->content}}</textarea>
