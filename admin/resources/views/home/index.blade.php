									...
									<div class="table-responsive">
										<table id="example1" class="display table table-striped table-hover" >
											...
											@foreach($homes as $home)
												<tr>
													<td>{{$i}}</td>
												   <td><a content="{!! $home->banner_text !!}"  class="btn btn-link btn-primary btn-lg content_view" >View</a></td>
												   <td><a href="{{url('public/images/'.$home->banner_image)}}"><img src="{{url('public/images/'.$home->banner_image)}}" width="70" class="pull-right" alt="User Image" /></a> </td>
												   <td><a content="{!! $home->how_to_start1 !!}"  class="btn btn-link btn-primary btn-lg content_view" >View</a></td>
												   <td><a content="{!! $home->how_to_start1 !!}"  class="btn btn-link btn-primary btn-lg content_view" >View</a></td>
												  <td><a content="{!! $home->how_to_start1 !!}"  class="btn btn-link btn-primary btn-lg content_view" >View</a></td>
												   <td>
													<form id="delete_form_{{$home->id}}" method="post" action="{{url('home/'.$home->id)}}" >
													@csrf
													@method('DELETE')
														<div class="form-button-action">
														<a href="{{url('home/'.$home->id)}}" data-toggle="tooltip" title="" class="btn btn-link btn-success btn-lg view" data-original-title="View">
																<i class="fa fa-eye"></i>
															</a>
															<a href="{{url('home/'.$home->id.'/edit')}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
...
<div class="modal fade" id="view_modal" role="dialog">
 ...
 <h4 class="modal-title"><i class="fas fa-info-circle"></i> Home Content Details</h4>
