	...
	<section>
		...
		<div class="">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tbody>
				@php 
				$user_datas = DB::table('referrals')->select('*')->where(['is_deleted'=>0,'teacher_id'=>$user_id])->get();@endphp
				@foreach($user_datas as $user_data)
					<tr>
						<td class="desc">Reffral</td>
						<td class="unit">{{$user_data->teacher_incentive}}%</td>
			...
			<div class="no-break">
				<table class="grand-total">
					<tbody>
						<tr>
						@php 
				$user_sum = DB::table('referrals')->where(['is_deleted'=>0,'teacher_id'=>$user_id])->sum('teacher_incentive');@endphp
			
							<td class="">SUBTOTAL:</td>
							<td class="total">{{$user_sum}}%</td>
						</tr>
					</tbody>
				</table>
			</div>
