						...
						<div class="col-md-12">
							<div class="card">
								...
								@endif
									...
									<div class="form-group form-show-validation row">
										<label for="validity" class="col-lg-3 ">Voucher Number <span class="required-label">*</span></label>
										<div class="col-lg-6">
										<input class="form-control numeric_feild" name="voucher_number" id="voucher_number" type="text" placeholder="Voucher Number" value="{{$voucher->voucher_number}}" required />
