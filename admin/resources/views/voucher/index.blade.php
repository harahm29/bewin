							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center pull-right">
									 <a href="{{url('voucher/create')}}" class="btn btn-primary pull-right btn-sm" data-toggle="tooltip" title="Create Voucher">
												...
												<tr>
												   ...
												   <td >{{date('d-m-y',strtotime($voucher->created_at))}}</td>
													...
													@method('DELETE')
														...
														<a href="{{url('voucher/'.$voucher->id)}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg view" data-original-title="View">
																<i class="fa fa-eye"></i>
															</a>
															<a href="{{url('voucher/'.$voucher->id.'/edit')}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
																<i class="fa fa-edit"></i>
															</a>
															<button id="{{$voucher->id}}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger delete" data-original-title="Delete">
