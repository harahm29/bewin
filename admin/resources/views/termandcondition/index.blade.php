									...
									<div class="table-responsive">
										<table id="example1" class="display table table-striped table-hover" >
											...
											@foreach($contents as $content)
												<tr>
													<td>{{$i}}</td>
												   <td ><a content="{!! $content->content !!}" href="{{url('termandcondition/'.$content->id)}}" class="btn btn-link btn-primary btn-lg content_view" >
																View
															</a></td>
													<td>
													...
													@method('DELETE')
														...
														<!--<a href="{{url('termandcondition/'.$content->id)}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg view" data-original-title="View">
																<i class="fa fa-eye"></i>
															</a>-->
															<a href="{{url('termandcondition/'.$content->id.'/edit')}}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
