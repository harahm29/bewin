...
@section('title','Term And Condition Create')
@section('content')
<style>
.cus_box_info
{
						...
						<div class="col-md-12">
							<div class="card">
								...
								@endif
									...
									<form method="post" action="{{url('termandcondition')}}" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data" >
									@csrf
									<div class="card-body">
