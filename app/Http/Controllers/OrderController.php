   ...
   public function orders($id=null)
	{
		if(Auth::user()->id==1)
		{
			...
			$orders = Order::select('orders.*','users.mobile_no',DB::raw("concat(users.first_name,users.last_name) as name"))
		...
		else
		{
			...
			$orders = Order::select('orders.*','users.mobile_no',DB::raw("concat(users.first_name,users.last_name) as name"))
			    ...
			    ->where(['orders.order_status'=>$id,'user_id'=>$user_id])
			    ->orderBy('orders.id','desc')->paginate(10);
			...
			$orders = Order::select('orders.*','users.mobile_no',DB::raw("concat(users.first_name,users.last_name) as name"))
			    ...
			    ->where(['orders.status'=>'complete','user_id'=>$user_id])
					->orderBy('orders.id','desc')->paginate(10);
			}
			elseif($id=="failed")
			{
			...
			$orders = Order::select('orders.*','users.mobile_no',DB::raw("concat(users.first_name,users.last_name) as name"))
			    ...
			    ->where(['orders.status'=>'failed','user_id'=>$user_id])
				->orderBy('orders.id','desc')->paginate(10);
			}
			elseif($id=="complete")
			{
			...
			$orders = Order::select('orders.*','users.mobile_no',DB::raw("concat(users.first_name,users.last_name) as name"))
			    ...
			    ->where(['orders.order_status'=>$id,'orders.status'=>'complete','user_id'=>$user_id])
					->orderBy('orders.id','desc')->paginate(10);
			}
		}
