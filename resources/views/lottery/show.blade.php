...
@php 
 ...
 <div class="page-area">
  ...
  <div class="lottery-area area-padding-2" style="background-color: #ccc;">
                 ...
                 <div class="row">
                    ...
                    <div class="lottery-content">
						...
						<div class="single-lottery">
						  ...
						  <div class="auto-number" style="border-bottom: 0px;margin-bottom:0px;padding-bottom:0px;">

                                    <div class="number-top">

                                        <input auto_random_no_radio="{{$lottery->id}}" for="auto-num-{{$lottery->id}}" class="radio_select" radio_type="auto" type="radio" id="auto-num-{{$lottery->id}}" name="auto-num-{{$lottery->id}}" value="auto{{$lottery->id}}"  >
						  ...
						  <div id="auto_message" style="display:@if($free_play==1)block @else none @endif;">

								<span class="text-danger"><b id="text_display">
								@if($free_play==1)
								In "Free Play", you can select only one ticket to play the lottery.	
								@else
								Auto Generated no. will be sent to your mail id after payment
								@endif
							</b></span><br>
						...
						<div class="single-lottery">
						  ...
						  <div class="manual-number">
                                    ...
                                    <div class="number-top">
                                        ...
                                        <input class="radio_select" radio_type="mannual" type="radio" id="manual-num-{{$lottery->id}}" name="auto-num-{{$lottery->id}}" value="mannual{{$lottery->id}}" > 
	...
	<input type="hidden" name="user_id" id="user_id" value="@if(Auth::check()){{Auth::user()->id}}@else 0 @endif" />
...

		{
			...
			if(user_id==0)

				{
					...
					location.href = "{{url('lottery-signin')}}";
		...
		$(document).ready(function(){
			...
			$(".ticket_no").on("keyup change",function(){
				...
				console.log("val >> "+val);
				var free_play = {{$free_play}};
				console.log("free_play >> "+free_play);
				if(free_play ==1)
				{
					$("#auto_message").show();
					$("#text_display").html('In "Free Play", you can select only one ticket to play the lottery.');
					$(".ticket_no").val(1);
					val = 1;
				}
				else
				{
					$("#auto_message").hide();
					$("#text_display").html("Auto Generated no. will be sent to your mail id after payment");
				}
					
					if(val > 1)
					{

						$(".auto-number").addClass("disabledbutton");
						$(".manual-number").addClass("disabledbutton");
					...
					else
					{
						...
						$(".auto-number").removeClass('disabledbutton');
						$(".manual-number").removeClass('disabledbutton');
			...
			$(".submit-btn").click(function(e){
				...
				//	e.preventDefault(); //mannual_powet_ball_li_
					...
					else
					{
						...
						$("#self-number-mannual-"+lottery_id+" li.mannual_select_result").each(function(){
						...
						$("#self-number-mannual-"+lottery_id+" li.mannual_power_ball_result").each(function(){
