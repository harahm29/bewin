                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10 text-center">
                                          <img class="img-circle" src="{{url('/public/images/successful-icon-10.jpg')}}" style="width: 150px;background: #fff" />
								<br><br> Transaction Success
                                        </div>
                                    </div>
                                     </div>
                            </div>
...
@if(Auth::user()->type=='user') 
	@if(session('lottery_back_url'))
		@php $url = session('lottery_back_url'); @endphp
	@else
		@php $url = 'my-banking'; @endphp
	@endif
