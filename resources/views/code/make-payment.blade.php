                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
										    ...
										    @endif
                                            <strong>Total Price:</strong>: <span class="text-navy">${{$price ?? ""}}</span><br>
                                            <strong>Wallet:</strong>: <span class="text-navy">${{$wallet ?? ""}}</span>

                                            <p class="m-t">
                                                You pay this lottery amount to play game.
                                            </p>
                                            <a href="@if($balance > 0) {{ url('code-payment') }} @else # @endif" class="btn btn-success">
