...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  align="center">
  <tbody>
    <tr>
      ...
      <td  align="center" valign="top"  width="33%"><h2>Transaction</h2><h3>{{$teachername->first_name}}</h3></td>
      @else
		<td  align="center" valign="top"  width="33%"><h2>Transaction</h2><h3>{{Auth::user()->first_name}}</h3></td>  
	  @endif
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="statement1_tble">
  <thead style="color:#fff;" class="text-success">
    <tr>
      ...
      <th align="left" valign="top">Order No</th>
      <th align="left" valign="top">Amount</th>
	  <th align="left" valign="top">Discount</th>
      <th align="left" valign="top">Discount %</th>
 ...
 <tbody>
    ...
    <tr>
				...
				<td align="left" valign="top"  class="last_td_all">{{$data->discount}}</td>		   
				<td align="left" valign="top"  class="last_td_all">{{$data->discount_per}}</td>		   
				<td align="left" valign="top"  class="last_td_all">{{$data->total}}</td>		   
    </tr>
    ...
    <tr>
      ...
      <td align="left" valign="top" class="last_td_all"><b>$ {{str_replace("-","",number_format(($total_discount),2))  }}</b></td>
      <td align="left" valign="top" class="last_td_all"><b>$ {{str_replace("-","",number_format(($total_discount_per),2))  }}</b></td>
      <td align="left" valign="top" class="last_td_all"><b>$ {{str_replace("-","",number_format(($total_amount),2))  }}</b></td>
    </tr>
